...
<ul>
    ...
    <li>Админ панель, в которой есть динамический поиск среди пользователей с подсвечиванием синтаксиса совпадения, фильтрация по динамическим ролям, пагинатор, возможность менять роль пользователям и удалять их</li>
