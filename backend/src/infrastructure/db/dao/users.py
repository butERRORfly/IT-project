from backend.src.domain.ports.trip_repository import UserRepository
from backend.src.domain.models.user import UserD, RoleD
from backend.src.infrastructure.db.database import async_session_maker, User, Role, Way, WayParameter
